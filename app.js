var budgetController=(function(){
	...
	return {
		...
		calculateBudget : function(){
			...
			//cal the percantage of income that we spent
...
var UIController=(function() {
	...
	return{
		...
		;
			...
			months = ['january' , 'february' , 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'novemer' , 'december'];
			 month= now.getMonth();
...
var controller=(function(budgetCtrl,UICtrl){
   ...
   document.addEventListener('keypress',function(event){
	...
	// read the percenage from the budget controller
	...
	var ctrlDeleteItem = function(event){
		...
		if(itemID){
			...
			//dalete the item from IU interface
